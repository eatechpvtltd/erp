...
class AddValidation extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'section'                       => 'required',  
            'transport'                     => ['required', 'in:Y,N'],
            'is_hostel'                     => 'required',
            'staff_id'                      => 'required',
            'location'                      => 'required_if:transport,Y',
    ...
    public function messages()
    {
        return [
            ...
            'is_hostel.required'             => 'Please specify whether you need hostel accommodation.',
            'staff_id.required'              => 'The staff field is required.',
            'location.required_if'           => 'The location field is required when transport is Yes.',
        ];
    }
}
