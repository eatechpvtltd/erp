...
class EditValidation extends FormRequest
{
    ...
    {
        return [
            'students_id'           => 'required | unique:character_certificates,students_id,'.decrypt($this->request->get('id')),
            'date_of_issue'         => 'required',
            'cc_num'                => 'required | unique:character_certificates,cc_num,'.decrypt($this->request->get('id')),
            'year'                  => 'required',
            'character'             => 'required',
        ];
