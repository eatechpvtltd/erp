...
class EditValidation extends FormRequest
{
    ...
    {
        return [
            'students_id'           => 'required | unique:transfer_certificates,students_id,'.decrypt($this->request->get('id')),
            'date_of_issue'         => 'required',
            'date_of_leaving'       => 'required',
            'tc_num'                => 'required | unique:transfer_certificates,tc_num,'.decrypt($this->request->get('id')),
