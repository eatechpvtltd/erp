...
class PurchaseController extends CollegeBaseController
{
    ...
    protected $folder_name = 'purchase';
    ...
    public function registration()
    {
        ...
        $vendor = Vendor::select('id', 'name')->Active()->pluck('name','id')->toArray();
        $data['vendor'] = array_prepend($vendor,'Select Vendor',0);

        $data['paymentMethod'] = PaymentMethod::select('id', 'title')->Active()->pluck('title','id')->toArray();
