...
class VendorController extends CollegeBaseController
{
    ...
    public function marketing()
    {
        ...
        return view(parent::loadDataToView($this->view_path.'.registration.marketing'));
    }

    public function marketing_register(Request $request){
        $vendor = Marketing::create($request->all());
        $data  = Marketing::all();
        return view(parent::loadDataToView($this->view_path.'.marketingview'),compact('data'));
    }
