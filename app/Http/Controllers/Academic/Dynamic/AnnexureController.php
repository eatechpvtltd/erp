...
class AnnexureController extends CollegeBaseController
{
    protected $base_route = 'dynamic.annexure';
    protected $view_path = 'academic.dynamic-hub.annexure';
    protected $panel;
    protected $filter_query = [];

    public function __construct()
    {
        $this->panel = __('academic.child.dynamic_gallery.child.annexure');
    }

    public function index(Request $request)
    {
        $data = [];
        $data['annexure'] = Annexure::get();
    ...
    public function edit(Request $request, $id)
    {
        $id = decrypt($id);
        $data = [];
        if (!$data['row'] = Annexure::find($id))
            return parent::invalidRequest();

        $data['annexure'] = Annexure::orderBy('title')->get();
    ...
    {
        $id = decrypt($id);
       if (!$row = Annexure::find($id)) return parent::invalidRequest();
