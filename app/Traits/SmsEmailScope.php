...
use App\Traits\SmsGateway\BulkSmsGatewaySMS;
use App\Traits\SmsGateway\BusinessWithTechnologySMS;
...
use App\Traits\SmsGateway\SamayaSMS;
...
trait SmsEmailScope{
    ...
    public function sendSMS($contactNumbers, $message)
    {
        ...
        switch ($activeProvider){
            case "SamayaSms":
                $this->SamayaSMS($contactNumbers, $message);
                break;

            case "BusinessWithTechnology":
                $this->BwTechSMS($contactNumbers, $message);
                break;
            ...
            case "BulkSmsGateway":
                $this->BulkSmsGatewaySMS($contactNumbers, $message);
                break;
