...
<div class="form-group">
    {!! Form::label('template', 'SMS Template', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-10">
        {!! Form::textarea('template', null, ["class" => "form-control border-form","rows"=>"4", "required"]) !!}
        @include('includes.form_fields_validation_message', ['name' => 'template'])
    </div>
</div>

<div class="form-group">
    {!! Form::label('subject', 'Email Subject', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-10">
...
<div class="form-group">
    {!! Form::label('email_template', 'Email Template', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-10">
        {!! Form::textarea('email_template', null, ["class" => "form-control border-form summernote", "required"]) !!}
