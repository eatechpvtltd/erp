...
<!--#generalInfo activeGeneralInfo()-->
<!--#extraInfo activeExtraInfo()-->
<!--#academicInfo activeAcademicInfo()-->   
<!--#profileImage activeProfileImage()-->
<!--#ruleAgreement activeRuleAgreement()"-->
...
<!--{{--                @endif--}}-->
        ...
        @if(Config::get('edufirmconfig.student.registration.tabs.academic_info') == 1)
            <div id="academicInfo" class="tab-pane">
                ...
                <hr>
                <div class="text-center">
                    <a class="btn btn-primary" data-toggle="tab" href="#extraInfo" onclick="activeExtraInfo()">
                        <i class="fa fa-arrow-circle-left bigger-110"></i> Previous
                    </a>
