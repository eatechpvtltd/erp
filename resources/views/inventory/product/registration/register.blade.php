            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        <a class="{!! request()->is('inventory/product/import*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('inventory.product.import') }}"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Bulk Product Registration</a>
                        </div>
