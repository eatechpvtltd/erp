                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="{{ route('inventory.vendor.note.edit', ['id' => encrypt($note->id)]) }}" class="btn btn-primary btn-minier btn-success">
                                        <i class="ace-icon fa fa-pencil-square-o bigger-130" title="Edit"></i>
                                    </a>

                                    <a href="{{ route('inventory.vendor.note.delete', ['id' => encrypt($note->id)]) }}" class="btn btn-primary btn-minier btn-danger bootbox-confirm" >
