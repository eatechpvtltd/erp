...
<meta property="og:image" content="{{ asset(isset($data['row']->image)?asset('web/notice/'.$data['row']->image):'images/general_settings/'. $generalSetting->page_banner) }}">
...
<meta name="twitter:image" content="{{ asset(isset($data['row']->image)?asset('web/notice/'.$data['row']->image):'images/general_settings/'. $generalSetting->page_banner) }}"/>