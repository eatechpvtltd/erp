                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                    <tbody>
                                                    <tr>
                                                        <td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">Contact Message : {{ $generalSetting->site_title}}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                    <table>
                                                        <tr>
                                                            <td colspan="2">
                                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                                    <b style="color: #777777;">Dear {{ $data['message_detail']->staff_name}},</b><br></br>
                                                                    You have received a contact message please respond to the sender as soon as possible.<br>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th colspan="2">Sender Detail:</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Name : </th>
                                                            <td>
                                                                {{$data['message_detail']->first_name.' '.$data['message_detail']->last_name}}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Email : </th>
                                                            <td>
                                                                {{$data['message_detail']->email}}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Phone : </th>
                                                            <td>
                                                                {{$data['message_detail']->phone}}
                                                            </td>
                                                        </tr>
