                        ...
                        <table class="table-space" height="16"
                            ...
                            <tr>
                                <td class="table-space-td" valign="middle" height="16"
                                    style="height: 16px; width: 600px; background-color: #ffffff;" width="600"
                        ...
                        <table class="table-row" width="600" bgcolor="#FFFFFF"
                            ...
                            <tr>
                                <td class="table-row-td"
                                    ...
                                    valign="top" align="left">
                                    <table class="table-col" align="left" width="528" cellspacing="0" cellpadding="0"
                                           border="0" style="table-layout: fixed;">
                                        <tbody>
                                        <tr>
                                            <td class="table-col-td" width="528"
                                                style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;"
                                                valign="top" align="left">
                                                <table class="header-row" width="528" cellspacing="0" cellpadding="0"
                                                       border="0" style="table-layout: fixed;">
                                                    <tbody>
                                                    <tr>
                                                        <td class="header-row-td" width="528"
                                                            ...
                                                            valign="top" align="left">{{  $data['title']  }} </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                    ...
                                    <table class="table-space" height="12"
                                        ...
                                        <tr>
                                            <td class="table-space-td" valign="middle" height="12"
                                                style="height: 12px; width: 600px; padding-left: 18px; padding-right: 18px; background-color: #ffffff;"
                                                width="600" bgcolor="#FFFFFF" align="center">&nbsp;
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td class="table-col-td" width="255"
                                                            ...
                                                            <table class="header-row" width="255" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="header-row-td" width="255"
                                                                        ...
                                                                        valign="top" align="left">Our Social Channels
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                            ...
                                                            <div style="font-family: Arial, sans-serif; line-height: 36px; color: #444444; font-size: 13px;">
                                                                ...
                                                                <a href="{{ $data['googlePlus_link'] }}"
                                                                   style="color: #b7837a; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border-width: 1px 1px 2px; border-style: solid; border-color: #d7a59d; padding: 6px 12px; font-size: 14px; line-height: 20px; background-color: #ffffff;">Google+</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                        ...
                                                        <td class="table-col-td" width="255"
                                                            ...
                                                            <table class="header-row" width="255" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="header-row-td" width="255"
                                                                        style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 8px; padding-top: 10px;"
                                                                        valign="top" align="left">Our Contact Info
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td class="table-col-td" width="528"
                                                            ...
                                                            <table class="table-space" height="16"
                                                                ...
                                                                <tr>
                                                                    <td class="table-space-td" valign="middle"
                                                                        ...
                                                                        width="528" bgcolor="#FFFFFF" align="left">
                                                                        &nbsp;</td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                            <div style="font-family: Arial, sans-serif; line-height: 19px; color: #777777; font-size: 14px; text-align: center;">&copy;
                                                                Kshitiz Educational Foundation
                                                            </div>
                                                            <table class="table-space" height="12"
                                                            ...
                                                            <div style="font-family: Arial, sans-serif; line-height: 19px; color: #bbbbbb; font-size: 13px; text-align: center;">
                                                                ...
                                                                &nbsp;|&nbsp;
                                                                <a href="#"
                                                                   style="color: #428bca; text-decoration: none; background-color: transparent;">Unsubscribe</a>
                                                            </div>
                                                            <table class="table-space" height="16"
                                                                   style="height: 16px; font-size: 0px; line-height: 0; width: 528px; background-color: #ffffff;"
                                                                   width="528" bgcolor="#FFFFFF" cellspacing="0"
