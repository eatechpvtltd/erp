...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Aryan Institute ERP" />
                                ...
                                @else
                                    ...
                                    @if(isset($data['general_setting']->institute))
                                        <!--<span class="white" id="id-text2">{{$data['general_setting']->institute}}</span>-->
                                         <span class="white" id="id-text2">Education ERP</span>
                                    @else
                                        <span class="red">Education College</span>
                                        <span class="white" id="id-text2">ERP</span>
                                    @endif
                                @endif
                                <br>
                                <span class="green" style="font-size: 17pt;">
                                {{ViewHelper::getGreeting()}}
                            </span>
                            </h1>
                        </div>
