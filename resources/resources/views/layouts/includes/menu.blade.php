        ...
        @if( isset($generalSetting) && $generalSetting->account ==1)
            <li class="{!! request()->is('account/*')?'active open':'' !!}  hover">
                ...
                <ul class="submenu">
                    ...
                    <li class="divider"></li>
                    <li class="{!!  request()->is('account/transaction-head/*') || request()->is('account/account-group/chart-of-account*') ?'active open':'' !!} hover">
                        <a href="#" class="dropdown-toggle">
                            <i class="menu-icon fa fa-caret-right"></i>
...
<!--                        <a href="#" class="dropdown-toggle">-->
<!--                            <i class="menu-icon fa fa-caret-right"></i>-->
<!--                            <i class="fa fa-store"></i> {{__('inventory.child.class_assets.name')}}-->
<!--                            <b class="arrow"></b>-->
<!--                        </a>-->
<!--                        <b class="arrow"></b>-->
<!--                        <ul class="submenu">-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    {{__('inventory.child.class_assets.child.assets')}}-->
<!--                                </a>-->
<!--                            </li>-->
<!--                            <li class="{!! request()->is('inventory/sem-assets')?'active':'' !!} hover">-->
<!--                                <a href="{{ route('inventory.sem-assets') }}">-->
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    {{__('inventory.child.class_assets.child.faculty_sem_assets')}}-->
<!--                                </a>-->
<!--                            </li>-->
<!--                        </ul>-->
<!--                    </li>-->
...
<!--                        <a href="#" class="dropdown-toggle">-->
<!--                            <i class="menu-icon fa fa-caret-right"></i>-->
<!--                            <span class="menu-text">{{__('inventory.child.assets.name')}}</span>-->
<!--                        </a>-->
<!--                        <b class="arrow"></b>-->
<!--                        <ul class="submenu">-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    <i class="fa fa-plus"></i> {{__('inventory.child.assets.child.add')}}-->
<!--                                </a>-->
<!--                                <b class="arrow"></b>-->
<!--                            </li>-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    <i class="fa fa-list"></i> {{__('inventory.child.assets.child.detail')}}-->
<!--                                </a>-->
<!--                                <b class="arrow"></b>-->
<!--                            </li>-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    <i class="fa fa-list-alt"></i> {{__('inventory.child.assets.child.category')}}-->
<!--                                </a>-->
<!--                                <b class="arrow"></b>-->
<!--                            </li>-->
...
<!--                        <a href="#" class="dropdown-toggle">-->
<!--                            <i class="menu-icon fa fa-caret-right"></i>-->
<!--                            {{__('inventory.child.customer.name')}}-->
<!--                            <b class="arrow"></b>-->
<!--                        </a>-->
<!--                        <b class="arrow"></b>-->
<!--                        <ul class="submenu">-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    {{__('inventory.child.customer.child.detail')}}-->
<!--                                </a>-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    {{__('inventory.child.customer.child.register')}}-->
<!--                                </a>-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    {{__('inventory.child.customer.child.documents')}}-->
<!--                                </a>-->
<!--                                <b class="arrow"></b>-->
<!--                            </li>-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"  ></i>-->
<!--                                    {{__('inventory.child.customer.child.notes')}}-->
<!--                                </a>-->
<!--                                <b class="arrow"></b>-->
<!--                            </li>-->
<!--                        </ul>-->
...
<!--                        <a href="#" class="dropdown-toggle">-->
<!--                            <i class="menu-icon fa fa-caret-right"></i>-->
<!--                            {{__('inventory.child.vendor.name')}}-->
<!--                            <b class="arrow"></b>-->
<!--                        </a>-->
<!--                        <b class="arrow"></b>-->
<!--                        <ul class="submenu">-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    {{__('inventory.child.vendor.child.register')}}-->
<!--                                </a>-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"></i>-->
<!--                                    {{__('inventory.child.vendor.child.documents')}}-->
<!--                                </a>-->
<!--                                <b class="arrow"></b>-->
<!--                            </li>-->
...
<!--                                    <i class="menu-icon fa fa-caret-right"  ></i>-->
<!--                                    {{__('inventory.child.vendor.child.notes')}}-->
<!--                                </a>-->
<!--                                <b class="arrow"></b>-->
<!--                            </li>-->
<!--                        </ul>-->
...
<!--{{--                        <a href="#" class="dropdown-toggle">--}}-->
<!--{{--                            <i class="menu-icon fa fa-caret-right"></i>--}}-->
<!--{{--                            {{__('inventory.child.purchase.name')}}--}}-->
<!--{{--                            <b class="arrow"></b>--}}-->
<!--{{--                        </a>--}}-->
<!--{{--                        <b class="arrow"></b>--}}-->
<!--{{--                        <ul class="submenu">--}}-->
...
<!--{{--                                    <i class="menu-icon fa fa-caret-right"></i>--}}-->
<!--{{--                                    {{__('inventory.child.purchase.child.detail')}}--}}-->
<!--{{--                                </a>--}}-->
...
<!--{{--                                    <i class="menu-icon fa fa-caret-right"></i>--}}-->
<!--{{--                                    {{__('inventory.child.purchase.child.new')}}--}}-->
<!--{{--                                </a>--}}-->
...
<!--{{--                                <a href="{{ route('inventory.vendor.document') }}"  >--}}-->
<!--{{--                                    <i class="menu-icon fa fa-caret-right"></i>--}}-->
<!--{{--                                    {{__('inventory.child.purchase.child.return')}}--}}-->
<!--{{--                                </a>--}}-->
<!--{{--                                <b class="arrow"></b>--}}-->
<!--{{--                            </li>--}}-->
<!--{{--                        </ul>--}}-->
...
<!--{{--                                <a href="{{ route('inventory.vendor') }}" >--}}-->
<!--{{--                                    <i class="menu-icon fa fa-caret-right"></i>--}}-->
<!--{{--                                    {{__('inventory.child.sales.child.detail')}}--}}-->
<!--{{--                                </a>--}}-->
...
<!--{{--                                <a href="{{ route('inventory.vendor.registration') }}">--}}-->
<!--{{--                                    <i class="menu-icon fa fa-caret-right"></i>--}}-->
<!--{{--                                    {{__('inventory.child.sales.child.new')}}--}}-->
<!--{{--                                </a>--}}-->
...
<!--{{--                                <a href="{{ route('inventory.vendor.document') }}"  >--}}-->
<!--{{--                                    <i class="menu-icon fa fa-caret-right"></i>--}}-->
<!--{{--                                    {{__('inventory.child.sales.child.return')}}--}}-->
<!--{{--                                </a>--}}-->
<!--{{--                                <b class="arrow"></b>--}}-->
<!--{{--                            </li>--}}-->
<!--{{--                        </ul>--}}-->
            ...
            <li class="{!! request()->is('library*')?'active':'' !!} hover">
                ...
                <ul class="submenu">
                        ...
                        <ul class="submenu">
                            <li class="{!! request()->is('library/member*')?'active':'' !!} hover">
                                <a href="{{ route('library.book') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.books.child.detail')}}
                                </a>
                            ...
                            <li class="{!! request()->is('library/book/add*')?'active':'' !!} hover">
                                <a href="{{ route('library.book.add') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.books.child.new')}}
                                </a>
                            ...
                            <li class="{!! request()->is('library/book/import*')?'active':'' !!} hover">
                                <a href="{{ route('library.book.import') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.books.child.import')}}
                                </a>
                            ...
                            <li class="{!! request()->is('library/book/category*')?'active':'' !!} hover">
                                <a href="{{ route('library.book.category') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.books.child.category')}}
                                </a>
                        ...
                        <ul class="submenu">
                            <li class="{!! request()->is('library/member*')?'active':'' !!} hover">
                                <a href="{{ route('library.member') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.members.child.membership')}}
                                </a>
                            ...
                            <li class="{!! request()->is('library/student*')?'active':'' !!} hover">
                                <a href="{{ route('library.student') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.members.child.student')}}
                                </a>
                            ...
                            <li class="{!! request()->is('library/staff*')?'active':'' !!} hover">
                                <a href="{{ route('library.staff') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.members.child.staff')}}
                                </a>
                    ...
                    <li class="{!! request()->is('library/request*') ?'active':'' !!} hover">
                        <a href="#" class="dropdown-toggle">
                            <i class="menu-icon fa fa-caret-right"></i>
                            {{__('library.child.book_request.name')}}
                            <b class="arrow"></b>
                        </a>
                        <b class="arrow"></b>
                        <ul class="submenu">
                            <li class="{!! request()->is('library/request-student*')?'active':'' !!} hover">
                                <a href="{{ route('library.student-request') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.book_request.child.student')}}
                                </a>
                            ...
                            <li class="{!! request()->is('library/request-staff*')?'active':'' !!} hover">
                                <a href="{{ route('library.staff-request') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('library.child.book_request.child.staff')}}
                                </a>
                    ...
                    <li class="{!! request()->is('library/issue-history*')?'active':'' !!} hover">
                        <a href="{{ route('library.issue-history') }}">
                            ...
                            {{__('library.child.issue_history.name')}}
                        </a>
                    ...
                    <li class="{!! request()->is('library/return-over*')?'active':'' !!} hover">
                        <a href="{{ route('library.return-over') }}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            {{__('library.child.return_period_over.name')}}
                        </a>
                    ...
                    <li class="{!! request()->is('library/circulation*')?'active':'' !!}  hover">
                        <a href="{{ route('library.circulation') }}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            {{__('library.child.circulation_setting.name')}}
                        </a>
            ...
            <li class="{!! request()->is('attendance*')?'active':'' !!} hover">
                ...
                <ul class="submenu">
                    <li class="hover">
                        <a href="#" class="dropdown-toggle">
                            <i class="menu-icon fa fa-caret-right"></i>
                            {{__('attendance.child.student.name')}}
                            <b class="arrow"></b>
                        </a>
                        <b class="arrow"></b>
                        <ul class="submenu">
                            <li class="{!! request()->is('attendance/student*')?'active':'' !!} hover">
                                <a href="{{ route('attendance.student') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('attendance.child.student.child.regular')}}
                                </a>
                            ...
                            <!--        <i class="menu-icon fa fa-caret-right"></i>-->
                            <!--        {{__('attendance.child.student.child.subject')}}-->
                            <!--    </a>-->
                    ...
                    <li class="{!! request()->is('attendance/staff*')?'active':'' !!} hover">
                        <a href="{{ route('attendance.staff') }}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            {{__('attendance.child.staff.name')}}
                        </a>
                    ...
                    <li class="{!! request()->is('attendance/report*')?'active open':'' !!} hover">
                        <a href="#" class="dropdown-toggle">
                            <i class="menu-icon fa fa-caret-right"></i>
                            {{__('attendance.child.attendance_report.name')}}
                            <b class="arrow"></b>
                        </a>
                        <b class="arrow"></b>
                        <ul class="submenu">
                            <li class="{!! request()->is('attendance/report/student*')?'active':'' !!} hover">
                                <a href="{{ route('attendance.report.student') }}">
                                    ...
                                    {{__('attendance.child.attendance_report.child.student')}}
                                </a>
                            </li>
                            ...
                            <li class="{!! request()->is('attendance/report/staff')?'active':'' !!} hover">
                                <a href="{{ route('attendance.report.staff') }}">
                                    <i class="fa fa-calendar"></i>
                                    {{__('attendance.child.attendance_report.child.staff')}}
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="{!! request()->is('attendance/master*')?'active':'' !!} hover">
                        <a href="{{ route('attendance.master') }}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            {{__('attendance.child.monthly_calendar.name')}}
                        </a>
                ...
                <ul class="submenu">
                    ...
                    <li class="{!! request()->is('dynamic*')?'active':'' !!} hover">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="{!! request()->is('dynamic/payment-method*')?'active':'' !!} hover">
                                <a href="{{ route('dynamic.payment-method') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    {{__('academic.child.dynamic_gallery.child.payment_method')}}
                                </a>
