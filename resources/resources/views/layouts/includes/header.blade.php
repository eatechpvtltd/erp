<head>
    ...
    <!--Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/images/favion.png') }}"  sizes="512x512">
...
<!--{{--    <link rel="stylesheet" href="{{ asset('assets/css/nepali.datepicker.v3.7.min.css') }}" />--}}-->
