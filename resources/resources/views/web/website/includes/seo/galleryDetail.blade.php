...
<meta name="description" content="{{ substr((isset($data['row']->description)?strip_tags(htmlspecialchars_decode($data['row']->description)):$generalSetting->site_desc),0,200) }}">
<meta name="keywords" content="{{ isset($generalSetting->site_keyword)?$generalSetting->site_keyword:"" }}">
<meta property="og:image" content="{{ asset(isset($data['row']->image_name)?asset('web/gallery/'.$data['row']->image_name):'images/general_settings/'. $generalSetting->page_banner) }}">
...
<meta property="og:description" content="{{substr((isset($data['row']->description)?strip_tags(htmlspecialchars_decode($data['row']->description)):$generalSetting->site_desc),0,200)}}"/>
<meta property="og:image" content="{{ asset(isset($data['row']->image_name)?asset('web/gallery/'.$data['row']->image_name):'images/general_settings/'. $generalSetting->page_banner) }}"/>
...
<meta name="twitter:description" content="{{substr((isset($data['row']->description)?strip_tags(htmlspecialchars_decode($data['row']->description)):$generalSetting->site_desc),0,200)}}"/>
<meta name="twitter:image" content="{{ asset(isset($data['row']->image_name)?asset('web/gallery/'.$data['row']->image_name):'images/general_settings/'. $generalSetting->page_banner) }}"/>