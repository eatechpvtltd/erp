<div class="form-group">
    {!! Form::label('certificate', 'Certificate Title', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-11">
...
<div class="form-group">
    {!! Form::label('student_photo', 'StudentPhoto', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-2">
    ...
    {!! Form::label('print_institute_head', 'Print Institute Head', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-2">
        {!! Form::select('print_institute_head', ["1"=>"Required","0"=>"NotRequired"], null, ['class' => 'form-control']) !!}
        @include('includes.form_fields_validation_message', ['name' => 'print_institute_head'])
    </div>

    {!! Form::label('background_status', 'Background Status', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-2">
    ...
    {!! Form::label('public_verify', 'Public Can Verify From Web', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-1">
        {!! Form::select('public_verify', ["1"=>"Enable","0"=>"Disable"], null, ['class' => 'form-control']) !!}
        @include('includes.form_fields_validation_message', ['name' => 'public_verify'])
    </div>
