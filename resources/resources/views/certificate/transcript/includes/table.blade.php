                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route($base_route.'.print', ['id' => encrypt($student->id), 'template' => 'TRANSCRIPT']) }}" class="btn btn-primary btn-minier" target="_blank">
                                        <i class="ace-icon fa fa-print bigger-130"></i> Transcript
                                    </a>

                                    <a href="{{ route($base_route.'.print', ['id' => encrypt($student->id), 'template' => 'SEMESTER WISE FINAL RESULT']) }}" class="btn btn-primary btn-minier" target="_blank">
