            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        <a class="{!! request()->is('inventory/vendor/import*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('inventory.vendor.import') }}"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Bulk {{$panel}} Import</a>
                        </div>
