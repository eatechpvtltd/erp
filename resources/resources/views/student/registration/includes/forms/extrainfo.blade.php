<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            {!! Form::text('total_fee_per_year', null, ["placeholder" => "", "class" => "form-control border-form input-mask-registration","required"]) !!}
        ...
        <div class="col-sm-6">
            {!! Form::text('bank_name', null, ["placeholder" => "", "class" => "form-control border-form input-mask-registration" ,"required"]) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            {!! Form::text('bank_code', null, ["class" => "form-control border-form" ,"required"]) !!}
        ...
        <div class="col-sm-4">
            {!! Form::text('bank_account_number', null, ["placeholder" => "", "class" => "form-control border-form" ,"required"]) !!}
