<div class="row">
    <div class="col-sm-12 align-right hidden-print">
        <a href="{{ route($base_route.'.edit', ['id' => encrypt($data['student']->id)]) }}" class="btn-primary btn-sm" >
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                @if($data['student']->national_id_1 && $data['student']->national_id_2)
                    <div class="profile-info-name"> {{$data['student']->national_id_1}} : </div>
                    <div class="profile-info-value">
                        <span class="editable" id="national_id_2">{{ $data['student']->national_id_2 }}</span>
                    </div>
                @endif

                @if($data['student']->national_id_3 && $data['student']->national_id_4)
                    <div class="profile-info-name"> {{$data['student']->national_id_3}} : </div>
                    <div class="profile-info-value">
                        <span class="editable" id="national_id_4">{{ $data['student']->national_id_4 }}</span>
                    </div>
                @endif
            </div>
            ...
            <div class="profile-info-row">
                @if($data['student']->section !="")
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="section">{{ $data['student']->section }}</span>
                    </div>
                @endif
                @if($data['student']->is_hostel != "")
                    <div class="profile-info-name">Accommodation :</div>
                    <div class="profile-info-value">
                        <span class="editable" id="is_hostel">{{ $data['student']->is_hostel == '1' ? 'Hostel' : 'Day Scholar' }}</span>
                    </div>
                @endif
            </div>
            ...
            <div class="profile-info-row">
                @if($data['student']->transport !="")
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="section">{{ $data['student']->transport == 'Y' ? 'Yes' : 'NO' }}</span>
                    </div>
                @endif

                @if($data['student']->staff_id != "" || $data['student']->staff_id != null)
                    <div class="profile-info-name"> Staff Name : </div>
                    <div class="profile-info-value">
                        <span class="editable" id="staff">{{  ViewHelper::getStaffNameById( $data['student']->staff_id ) }}</span>
                    </div>
                @endif
...
<div class="row">
    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            @if($data['student']->national_id_1 !="")
                <div class="profile-info-name"> ID 1. : </div>
                <div class="profile-info-value">
                    <span class="editable">{{ $data['student']->national_id_1 }}</span>
                </div>
            @endif
            @if($data['student']->national_id_2 !="")
                <div class="profile-info-name"> PAN : </div>
                <div class="profile-info-value">
                    <span class="editable">{{ $data['student']->national_id_2 }}</span>
                </div>
            @endif
        </div>
    </div>
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            @if($data['student']->national_id_3 !="")
                <div class="profile-info-name"> ID 3. : </div>
                <div class="profile-info-value">
                    <span class="editable">{{ $data['student']->national_id_3 }}</span>
                </div>
            @endif
            @if($data['student']->national_id_4 !="")
                <div class="profile-info-name"> ID 4 :</div>
                <div class="profile-info-value">
                    <span class="editable">{{ $data['student']->national_id_4 }}</span>
                </div>
            @endif
        </div>
    </div>
