                                    ...
                                    <table>
                                        <tr>
                                            <td width="80%" class="text-center">
                                                ...
                                                <div class="col-md-11 text-center">
                                                    ...
                                                    <h6 class="no-margin-top" style="font-size: 10px">
                                                    ...
                                                    <h5 class="no-margin-top" style="font-size: 12px;">
                                                       {{isset($generalSetting->phone)?$generalSetting->phone:""}} | {{isset($generalSetting->email)?$generalSetting->email:""}} | {{isset($generalSetting->website)?$generalSetting->website:""}}
                                                    </h5>
                                        ...
                                        <span class="profile-picture">
                                            ...
                                            @endif
                                                ...
                                                <img class="editable img-responsive" alt="{{ $data['student']->title }}" src="{{ asset('images'.DIRECTORY_SEPARATOR.$folder_name.DIRECTORY_SEPARATOR.$data['student']->student_signature) }}" width="200px" />
                                            </span>
                                                @else
...
{{--                                            <td style="text-align: center; "><b>Percentage</b></td>--}}
                                            <td style="text-align: center; "><b>GradePoint</b></td>
                                            <td style="text-align: center; "><b>GradeLetter</b></td>
                                        </tr>
